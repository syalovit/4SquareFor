...
- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSHTTPURLResponse *)response {    
    ...
    if ([_delegate instancesRespondToSelector:@selector(restConnection:didReceiveResponse:object:)]) {
...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error {  
   ...
   // if([_delegate instancesRespondToSelector:@selector(restConnection:didFailWithError:object:)]) {        
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {    
    ...
    if([_responseData length] > 0) {
        ...
        if(parseError) {
           ...
           // if([_delegate instancesRespondToSelector:@selector(restConnection:didReceiveParseError:responseBody:object:)]) {
    ...
    //if([_delegate instancesRespondToSelector:@selector(restConnection:didReturnResource:object:)]) {        
